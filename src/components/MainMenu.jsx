            ...
            <section className="leftPanel">
                <div id="rectangle-left-panel" className="glass-panel">
                    ...
                    <button id="team-icon" className="icon">
                        ...
                        <img src="https://img.icons8.com/?size=96&id=aSlhg0UOn67Q&format=png" alt="Команда"
                             className="img-default"/>
                    ...
                    <button id="quests-icon" className="icon">
                        ...
                        <img src="https://img.icons8.com/?size=96&id=ljwCE5MTJHVo&format=png" alt="Задания"
                             className="img-default"/>
